"""Automates the process of keeping a Streamlit app awake by clicking the "Yes, get this app back up" button if it appears."""
...
if not STREAMLIT_URL:
    raise SystemExit("STREAMLIT_URL is not set")


def main() -> None:
    """Keep the Streamlit app awake."""
    options = Options()
